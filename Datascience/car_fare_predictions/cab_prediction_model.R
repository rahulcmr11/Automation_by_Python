...
# loading datasets
train = read.csv("C:/Users/212586594/Desktop/All_Imp/data Science/assignmnet/Portfolio/Portfolio_3/input/train_cab/train_cab.csv", header = T, na.strings = c(" ", "", "NA"))
test = read.csv("C:/Users/212586594/Desktop/All_Imp/data Science/assignmnet/Portfolio/Portfolio_3/input/testtest.csv")
